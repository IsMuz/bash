...
#   stable
WINESTABLEVERSION="4.0.3"
WINESTABLESHA1SUM="c8d19a0ee0cb7b5f9b45ef4b8441990b8976dcf8"

#   devel
WINEDEVELVERSION="4.21"
WINEDEVELSHA1SUM="903d4929d5fa5a7b3a4fe33d56b02002f8666764"

#   CrossOver Wine
CROSSOVERVERSION="18.5.0"
CROSSOVERSHA1SUM="6f3519804c6d8fa77f02b0e49655d47c23d8b64c"
...
if [ ${BUILDSTABLE} -eq 1 ] || [ ${BUILDDEVEL} -eq 1 ] ; then
	WINEFILE="wine-${WINEVERSION}.tar.xz"
	WINEURL="https://netcologne.dl.sourceforge.net/project/wine/Source/${WINEFILE}" 
...
APPLEGCCURL="https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/osxwinebuilder/${APPLEGCCFILE}"
...
TIFFSHA1SUM="7a882f8d55fd0620cbf89c47994d2d1d3b975452"
...
GSMURL="https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/osxwinebuilder/${GSMFILE}" 
...
LIBGCRYPTSHA1SUM="2d8781e92f88706707a1e76fb628b499ad538a30"
...
GMPURL="https://gmplib.org/download/gmp/gmp-${GMPVER}/${GMPFILE}"
GMPSHA1SUM="366ded6a44cd108ba6b3f5b9a252eab3f3a95cdf"
GMPDIR="gmp-${GMPVER}"
function clean_gmp {
...
P11KITURL="https://github.com/p11-glue/p11-kit/releases/download/${P11KITVER}/${P11KITFILE}"
P11KITSHA1SUM="1869a48bdaea6c6d1c89348b4f8964b14d6c2949"
...
#
GNUTLSVER="3.1.5"
GNUTLSFILE="gnutls-${GNUTLSVER}.tar.xz"
GNUTLSURL="ftp://ftp.gnu.org/pub/gnu/gnutls/${GNUTLSFILE}"
GNUTLSSHA1SUM="93efeab75cad6f656eae1123c10e3692db727bd5"
...
function extract_gnutls {
	extract_file "${TARXZ}" "${WINESOURCEPATH}/${GNUTLSFILE}" "${WINEBUILDPATH}" "${GNUTLSDIR}"
}
...
LIBEXIFURL="https://netcologne.dl.sourceforge.net/project/libexif/libexif/${LIBEXIFVER}/${LIBEXIFFILE}" 
LIBEXIFSHA1SUM="a52219b12dbc8d33fc096468591170fda71316c0"
...
LIBUSBSHA1SUM="10116aa265aac4273a0c894faa089370262ec0dc"
...
GDURL="https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/osxwinebuilder/${GDFILE}"
...
# sane-backends
#
SANEBACKENDSVER="1.0.25"
SANEBACKENDSFILE="sane-backends-${SANEBACKENDSVER}-macosx.tar.gz"
...
SANEBACKENDSURL="http://www.ellert.se/PKGS/sane-backends-${SANEBACKENDSVER}-p1/src/${SANEBACKENDSFILE}" 
SANEBACKENDSSHA1SUM="7ddcb2ecbb90e10f74f94e5e21f2a48eb82717f0"
...
function extract_sanebackends {
	extract_file "${TAR}" "${WINESOURCEPATH}/${SANEBACKENDSFILE}" "${WINEBUILDPATH}" "${SANEBACKENDSDIR}"
}
...
ORCURL="https://gitlab.freedesktop.org/gstreamer/orc/-/archive/${ORCVER}/${ORCFILE}" 
ORCSHA1SUM="63e6c1c7af989cb0a18a7fc623bb82b03b534d17"
ORCDIR="orc-${ORCVER}"
function clean_orc {
...
GITURL="https://mirrors.edge.kernel.org/pub/software/scm/git/${GITFILE}" 
GITSHA1SUM="278eae9d50f89a519522f6b288cabcb5ca583ef6"
...
GECKOVERSIONS="2.21 2.24 2.34 2.36 2.40"
GECKOSHA1SUMS="a514fc4d53783a586c7880a676c415695fe934a3 b4923c0565e6cbd20075a0d4119ce3b48424f962 e9646cf9d683a6f4e254bcff3864a863fe8287e9 08b02bf0e3ff3a315135afa1132ddb3a25a63e15 7001a6ed5b02d0ae4e73b14c92018d604b87f3ad"
function get_gecko {
	for GECKOVERSION in ${GECKOVERSIONS} ; do
		GECKOFILE="wine_gecko-${GECKOVERSION}-x86.msi"
		GECKOURL="https://liquidtelecom.dl.sourceforge.net/wine/Wine%20Gecko/${GECKOVERSION}/${GECKOFILE}" 
...
MONOVERSIONS="0.0.8 4.5.2 4.5.4 4.5.6"
MONOSHA1SUMS="dd349e72249ce5ff981be0e9dae33ac4a46a9f60 73d6b8aa7a8921f43b22c6d930e8d7e421058187 2b271d0bc92d5c9c45febd76fb11f9fcc29ea6d8 12ec9a4fa5958426292effd40d9230c7acbba1e8"
function get_mono {
